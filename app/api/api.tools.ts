...
import { UIFlowDto } from "../dtos/ui-flow-dto";
  ...
  export async function getAllToolsAPI(): Promise<ToolDto[]> {
    const response = await fetch(`https://localhost:49165/api/Tools/all`,
    { cache: 'no-store' });
  ...
  export async function getAllCoreToolsAPI(): Promise<CoreToolDto[]> {
    const response = await fetch(`https://localhost:49165/api/Tools/all/core`,
    { cache: 'no-store' });
  ...
  export async function getAllAIToolsAPI(): Promise<AIToolDto[]> {
    const response = await fetch(`https://localhost:49165/api/Tools/all/ai`,
    { cache: 'no-store' });
  ...
  export async function getAllAppsAPI(): Promise<AppDto[]> {
    const response = await fetch(`https://localhost:49165/api/Tools/all/apps`,
    { cache: 'no-store' });
